...
export const getAllParticipantsByEvent = async (bodySend) => {
	try {
		...
		const queryResponse = await axios.post(
			process.env.REACT_APP_API_URL + '/participantsByEvent',
			bodySend,
...
export const getAllParticipantsByEventWithCustomFields = async (bodySend) => {
	try {
		console.log('from api call', bodySend);
		const queryResponse = await axios.post(
			process.env.REACT_APP_API_URL + '/participantsCV',
			bodySend,
			// { headers: { "Content-Type": "application/json", "Access-Control-Allow-Origin": "true" } },
			{
				headers: {
...
export const getEventsByPromoter = async (eventBodySend) => {
	try {
		const eventResponse = await axios.post(
			process.env.REACT_APP_API_URL + '/getEventsByPomoter',
			eventBodySend,
			{
				headers: {
					'Content-Type': 'application/json',
...
export const updateEvent = async (eventBodySend) => {
	try {
		console.log('from api call', eventBodySend);
		const eventResponse = await axios.post(
			process.env.REACT_APP_API_URL + '/updateEvent',
			eventBodySend,
			{
				headers: {
					'Content-Type': 'application/json',
...
export const getEventsByDate = async (eventBodySend) => {
	try {
		// console.log('get all from api call')
		const eventResponse = await axios.post(
			process.env.REACT_APP_API_URL + '/getEventsByDate',
			eventBodySend,
			{
				headers: {
					'Content-Type': 'application/json',
